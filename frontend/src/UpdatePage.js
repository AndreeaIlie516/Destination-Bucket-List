...
const UpdatePage = () => {
    ...
    const handleSubmit = async () => {
        const response = await fetch(`https://localhost:7183/api/PublicDestinations/${id}`, {
            method: 'PUT',
            headers: {
        ...
        return (
            <>
                ...
                <Container sx={{ width: '100%', marginTop: '3em' }}>
                    ...
                    <Button onClick={handleSubmit} sx={{ marginTop: '2em' }}>Update</Button>
                </Container>
            </>
        )
    }
