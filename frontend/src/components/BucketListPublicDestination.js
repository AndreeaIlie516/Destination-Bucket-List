...
const BucketListPublicDestination = () => {
    const { id } = useParams();
                ...
                <Box sx={{ borderRadius: '1em', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', width: '80%', maxWidth: '1080px' }}>
                    ...
                    <Box sx={{ p: 3 }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                            <Button variant="contained" color="primary" onClick={handleUpdate} sx={{ mr: 1 }}>Update stay dates</Button>
...
export default BucketListPublicDestination;
