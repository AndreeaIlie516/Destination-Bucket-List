...
import PrivateDestinationGrid from './PrivateDestinationGrid';
import background from '../view_background.jpeg'
import { useParams } from 'react-router-dom';

export default function PrivateDestinationGridTemplateAreas() {
  const { id } = useParams();
  return (
    <Box
      sx={{
